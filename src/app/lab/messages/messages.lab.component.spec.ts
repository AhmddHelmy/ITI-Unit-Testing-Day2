...
import { MessagesComponentForLab } from './messages.lab.component'; // Import your component
...
describe("message component integration testing", () => {
  ...
  it("expect component created successfully", () => {
  ...
  it("expect div.msg to have the messages after setting it", () => {
